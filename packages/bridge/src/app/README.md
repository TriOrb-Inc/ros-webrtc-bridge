...
run the media worker named by `BRIDGE_VIDEO_WORKER`, which the launcher points at the installed copy;
a host that cannot provide the selected encoder fails the startup probe.
